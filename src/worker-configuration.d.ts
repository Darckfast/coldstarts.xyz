/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: e2c7dcb70bff3aa05d4bb1dc10b47652)
// Runtime types generated with workerd@1.20260603.1 2026-06-08 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	TIMES: KVNamespace;
	ASSETS: Fetcher;
	DURABLE_SSE: DurableObjectNamespace /* DurableSSE from sse */;
	WORKER: Fetcher /* worker */;
	WORKER_GO_WASM: Fetcher /* worker-go-wasm */;
}
