/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: f42295262bc290cdc600c3332e071919)
// Runtime types generated with workerd@1.20260603.1 2026-06-08 nodejs_als,nodejs_compat
interface __BaseEnv_Env {
	TIMES: KVNamespace;
	ASSETS: Fetcher;
	WORKER_URL: string;
	WORKER_GO_URL: string;
	DURABLE_SSE: DurableObjectNamespace /* DurableSSE from durable-sse */;
	WORKER: Fetcher /* edge-cold-start-cf-worker */;
	WORKER_GO: Fetcher /* edge-cold-start-cf-worker-go */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKER_URL" | "WORKER_GO_URL">> {}
}
